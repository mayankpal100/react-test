...
import type { ProductInfo } from '../store'
...
const StatisticCard = ({ data = {} }: { data: Partial<ProductInfo> }) => {
    return (
        <>
            <Card>
                <div className="flex items-center gap-4">
                    <StatisticIcon type={'newLeads'} />
                    <div>
                        <div className="flex gap-1.5 items-end mb-2">
                            <p className="font-semibold">Total Product Live</p>
                            <h3 className="font-bold leading-none">{data.total_products_live}</h3>

                        </div>
                        {/*<p className="flex items-center gap-1">*/}
                        {/*    <GrowShrink value={data.total_impressions || 0} />*/}
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex gap-1.5 items-end mb-2">
                            ...
                            <h3 className="font-bold leading-none">{data.total_impressions}</h3>
                        </div>
                        {/*<p className="flex items-center gap-1">*/}
                        {/*    <GrowShrink value={data.total_impressions || 0} />*/}
                        {/*    <span>this month</span>*/}
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex gap-1.5 items-end mb-2">
                            ...
                            <h3 className="font-bold leading-none">{data.total_add_to_cart}</h3>
                        </div>
            ...
            <Card>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex gap-1.5 items-end mb-2">
                            <p className="font-semibold">New Shoppers</p>
                            <h3 className="font-bold leading-none">{data.total_impressions}</h3>
                        </div>
...
const Statistic = ({ data = {} }: { data?: Partial<ProductInfo> }) => {
    return (
